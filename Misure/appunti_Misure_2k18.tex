...
\begin{figure}[H]
  ...
  \end{center}
\end{figure}
Integrando la PDF Gaussiaa tra due valori sull'asse reale si trova la probabilità che il risultato (misura) "cada" nell'intervallo compreso tra i due valori considerati.\\
